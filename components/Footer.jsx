  ...
  return (
    <footer className="relative bg-white border-t border-gray-100 overflow-hidden pt-16 pb-8">
      ...
      <div className="relative container-default z-10">
        ...
        {/* Footer Bottom */}
        <div className="pt-8 border-t border-gray-100 flex flex-col md:flex-row justify-between items-center gap-4 text-xs font-medium text-body/40 tracking-wider uppercase">
          <p>© {new Date().getFullYear()} Moving World. All Rights Reserved.</p>
