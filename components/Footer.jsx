        ...
        <div className="grid gap-12 lg:grid-cols-[1.5fr_1fr_1.2fr] mb-12">
          ...
          <div>
            ...
            <div className="space-y-4">
              ...
              {/* <div className="group bg-surface rounded-3xl p-6 border border-gray-100 hover:border-plum/20 transition-all duration-300">
                <div className="flex items-start gap-4">
                  <div className="w-10 h-10 rounded-xl bg-plum/5 flex items-center justify-center flex-shrink-0 group-hover:bg-plum group-hover:text-white transition-all duration-300">
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                    </svg>
                  </div>
                  <div>
                    <div className="text-xs font-bold text-muted uppercase tracking-wider mb-1">Call Us</div>
                    <a href="tel:+919910017177" className="text-plum font-semibold hover:text-primary transition-colors block">
                      +91 99100 17177
                    </a>
                  </div>
                </div>
